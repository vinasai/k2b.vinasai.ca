...
export default function Sidebar({
  ...
  return (
    <>
      ...
      ></div>
      <aside
        className={`fixed inset-y-0 left-0 w-72 bg-gray-800 border-r border-gray-700 flex flex-col z-30 transform transition-transform duration-300 md:relative md:translate-x-0 min-h-0 ${
